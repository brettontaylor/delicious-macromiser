...
|---|---|---|---|
| **E1 — Prescribed session & training block** — 🟡 **Phases 1-2 shipped 2026-08-24** (S-5, S-6, S-7, S-19, S-22, M-2); append and patterns remain | S-5, S-6, S-7, S-8, S-18, S-19, S-22, S-24, S-31, M-2 | Large | The transcript's highest-value output has nowhere to live. [PRODUCT.md](../PRODUCT.md) §2 names training history *the* differentiator; a prescription is that differentiator pointed forward instead of back. |
...
| 🟡 3 | **E1 — Prescribed session & block** | **Phases 1-2 shipped 2026-08-24.** Session append (Phase 4) and pattern surfacing (Phase 5) remain. [training-block.md](training-block.md). |
