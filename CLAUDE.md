...
This project is indexed by GitNexus as **delicious-macromiser** (565 symbols, 1393 relationships, 44 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/delicious-macromiser/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/delicious-macromiser/context` | Codebase overview, check index freshness |
| `gitnexus://repo/delicious-macromiser/clusters` | All functional areas |
| `gitnexus://repo/delicious-macromiser/processes` | All execution flows |
| `gitnexus://repo/delicious-macromiser/process/{name}` | Step-by-step execution trace |
